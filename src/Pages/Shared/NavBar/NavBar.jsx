...
const NavBar = () => {
    ...
    const navOptions = <div className="md:flex md:items-center">
            ...
            <div className="navbar fixed z-10 bg-opacity-30 bg-black text-white max-w-screen-xl mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-black text-white rounded-box w-52">
                            {navOptions}
                        </ul>
                    </div>
